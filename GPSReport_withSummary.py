...
def writehtml(Lat,Long,CaseID,Summary):
    myfile = "mymap_withSummary.html"
    f = open(myfile, 'w')
    f.write("<html>\n")
    f.write("<head>\n")
    ...
    f.write('\n')
    for lat, lng, caseid, summary in zip(Lat, Long, CaseID, Summary):
...
writehtml(GPSLat,GPSLong,CaseID,Summary)
#print(Timedata)
